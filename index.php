...
<head>
    ...
    <meta name="Emma Arreola" content="">
...
?>
<img src="images/home/<?php echo $img;?>.jpg" alt="" width=180 height=150/>
<h2><?php echo $productoB;?></h2>
<p><?php echo $precioB;?></p>
	<a href="cart.php?producto=<?php echo $productoB;?>&precio=<?php echo $precioB;?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Agregar al Carrito</a>							</div>
								...
								<div class="item active">	
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/home/corset.jpg" alt="" />
													<h2>$80</h2>
													<p>Producto Corset</p>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/home/faldaa.jpg" alt="" />
													<h2>$85</h2>
													<p>Producto falda</p>
													<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Agregar al Carrito</a>
												</div>
