...
<?php
 ...
 foreach($filas as $value){
  ...
  $BDAlmacen = array( 
    ...
    array(0,10, 5,15, 3 , 4, 5)); //Las Existencias
...
<head>
    ...
    <meta name="Gabriela Arreola" content="">
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +52 618 302 1421</a></li>
		...
		<div class="header-middle"><!--header-middle-->
			<div class="container">
				<div class="row">
					...
					<H3>SOFTWARE PUNTODE VENTA</H3>
					<div class="col-sm-8">
						por: Gabriela Arreola
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="agregarprodutos.php" target="_blank"><i
